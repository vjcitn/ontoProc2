...
- [`bbop_sqlite_db_gz()`](https://github.com/vjcitn/ontoProc2/reference/bbop_sqlite_db_gz.md)
  : retrieve and cache all filenames of Semantic SQL ontologies
  available, checking for updated content relative to cache via ETag

- [`cells_with_pmp()`](https://github.com/vjcitn/ontoProc2/reference/cells_with_pmp.md)
  : produce a table with cells exhibiting given proteins on plasma
  membrane according to CL

- [`cn2tag`](https://github.com/vjcitn/ontoProc2/reference/cn2tag.md) :
...
- [`get_present_pmp()`](https://github.com/vjcitn/ontoProc2/reference/get_present_pmp.md)
...
- [`improve_nodes()`](https://github.com/vjcitn/ontoProc2/reference/improve_nodes.md)
...
- [`print()`](https://github.com/vjcitn/ontoProc2/reference/print.md) :
  ...
  Show method for SemsqlConn. Concise one-line summary displayed when a
  `SemsqlConn` object is auto-printed at the R prompt.
...
- [`tag2cn`](https://github.com/vjcitn/ontoProc2/reference/tag2cn.md) :
